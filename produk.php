            ...
            <form method="post">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="text" name="Edit_Kode_Produk" value="<?php echo $d['kode_produk']; ?>" class="form-control" required onkeypress='return harusAngka(event)'>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" placeholder="0" name="Edit_Harga_Modal" value="<?php echo $d['harga_modal']; ?>" class="form-control" required onkeypress='return harusAngka(event)'>
                </div>
                <div class="form-group">
                  <label class="samll">Harga Jual :</label>
                  <input type="text" placeholder="0" name="Edit_Harga_Jual" value="<?php echo $d['harga_jual']; ?>" class="form-control" required onkeypress='return harusAngka(event)'>
                </div>
              </div>
    ...
    <div class="modal-content border-0">
      <form method="post">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label class="samll">Kode Produk :</label>
            <input type="text" name="Tambah_Kode_Produk" class="form-control" required onkeypress='return harusAngka(event)'>
          </div>
          <div class="form-group">
            <label class="samll">Nama Produk :</label>
          ...
          <div class="form-group">
            <label class="samll">Harga Modal :</label>
            <input type="text" placeholder="0" name="Tambah_Harga_Modal" class="form-control" required onkeypress='return harusAngka(event)'>
          </div>
          <div class="form-group">
            <label class="samll">Harga Jual :</label>
            <input type="text" placeholder="0" name="Tambah_Harga_Jual" class="form-control" required onkeypress='return harusAngka(event)'>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
