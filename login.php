...
<body class="text-center">
  ...
  <form class="form-signin" method="POST">
    <img class="mb-4" src="assets/images/rimuru.jpg" alt="" width="72" height="72">
    ...
    <p class="mt-3 mb-3 text-white">&copy; <script>
        document.write(new Date().getFullYear());
      </script> Developed by - <a target="_blank" rel="noopener noreferrer" href="https://facebook.com/azis74gaul" class="text-white">
        Azis Maulana</a></p>
  </form>
