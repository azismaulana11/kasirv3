      ...
      <form method="post">
        ...
        <div class="row">
          ...
          <div class="col-8 col-sm-8 col-md-8 col-lg-9 mb-2">
            <input type="text" name="pembayaran" onchange="procesBayar()" class="form-control form-control-sm" id="pembayaran" placeholder="0" required onkeypress='return harusAngka(event)'>
          </div>
